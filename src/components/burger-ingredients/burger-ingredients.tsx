...
export const BurgerIngredients: FC = () => {
  ...
  const buns = useAppSelector(bunsIngredientsFind);

  const mains = useAppSelector(mainsIngredientsFind);

  const sauces = useAppSelector(saucesIngredientsFind);
  ...
  const scrollIngredients = (tab: string) => {
